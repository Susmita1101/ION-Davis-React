...
import { View, Text ,TextInput, SafeAreaView, FlatList, StyleSheet, StatusBar, Image , TouchableOpacity, ImageBackground, ScrollView} from 'react-native';
...
const DATA = [
  ...
  {
    id: '6',
    title: 'Glass and Plastic sheets',
    url:''
  },
  {
    id: '7',
...
export default ChildSubcategory = ({route, navigation }) =>  {
  ...
  return (
    <View style={{ flex:1, height: "100%",  justifyContent: 'flex-start' , backgroundColor: colors.background }}>      
      ...
      <View style={{paddingHorizontal:0}}>
          ...
          <Text style={styles.text}>Lumber & Composites</Text>
